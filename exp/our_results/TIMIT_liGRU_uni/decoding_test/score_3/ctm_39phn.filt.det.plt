...
set noxtics
set noytics
set title 'DET plot for /scratch/ravanelm/exp/TIMIT_liGRU_official_uni_v3/decoding_test/score_3/ctm_39phn.filt'
set nokey
...
plot [-3.290527:3.290527] [-3.290527:3.290527] \
 "/scratch/ravanelm/exp/TIMIT_liGRU_official_uni_v3/decoding_test/score_3/ctm_39phn.filt.det.dat.00" using 2:1 title "/scratch/ravanelm/exp/TIMIT_liGRU_official_uni_v3/decoding_test/score_3/ctm_39phn" with lines 1
set ytics
set xtics
set size 1.0, 1.0
set key
